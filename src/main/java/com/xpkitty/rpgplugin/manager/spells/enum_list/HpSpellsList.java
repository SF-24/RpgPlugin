...
public enum HpSpellsList {
    ...
    LUMOS(Arrays.asList(0,2),"Lumos","Wand-Lighting Charm","Charm",1, 15,10,1, 6, Collections.emptyList(), 107, "", -15),
    NOX(Collections.singletonList(5),"Nox","Wand-Extinguishing charm","Charm",0, 15,5,1, 5, Collections.emptyList(), 108, "", -16),
